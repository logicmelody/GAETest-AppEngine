 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "gaetest.dl", ownerName = "gaetest.dl", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyB9t65HbanvL29mik6MpndJyaKFEcaf_C4";
